...
import { ArrowLeft, LineChart, TrendingUp, Users, ShieldCheck, CheckCircle } from "lucide-react";
import { useProgress } from "@/hooks/useProgress";

const moduleTitle = "Macroéconomie";
...
const chapters = [
  {
    ...
    description: "Définir, mesurer et analyser les sources et les défis de la croissance économique.",
  ...
  },
  {
    ...
    description: "Comprendre les cycles économiques, les crises et les indicateurs de fluctuation.",
  ...
  },
  {
    ...
    description: "Analyser les causes et conséquences du chômage et de l'inflation, et leur relation.",
  ...
  },
  {
    ...
    description: "Étudier comment les politiques budgétaire et monétaire visent à réguler l'activité économique.",
...
export default function MacroeconomiePage() {
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
          La macroéconomie étudie les phénomènes économiques à l'échelle globale : croissance, inflation, chômage et politiques économiques.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        {chapters.map((chapter) => {
          ...
          return (
            <Link key={chapter.id} href={`/economie/macroeconomie/${chapter.slug}`}>
      ...
      <div className={`bg-gradient-to-r from-${accentColor}/10 to-${accentColor}/5 dark:from-${accentColor}/20 dark:to-${accentColor}/10 p-6 rounded-lg shadow-sm`}>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Assurez-vous d'avoir bien compris les concepts clés de la macroéconomie pour réussir votre examen.
        </p>
        <Link
          href={`/quiz/economie/macroeconomie`}
